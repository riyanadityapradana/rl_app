...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>10 BESAR PENYAKIT RAWAT INAP SECARA UMUM</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="main_app.php?page=10_besar_penyakit_ranap_per_ruangan">10 besar penyakit per ruangan / kelas</a></li>
                </ol>
            </div>
        </div>
    </div>
