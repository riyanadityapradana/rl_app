...
// Query data pembatalan pasien sesuai rentang tanggal
...
<head>
    <meta charset="UTF-8">
    <title>Laporan Pembatalan PI-Care</title>
    <style>
        @media print {
            body { margin: 0; }
...
<body>
    ...
    <div class="header">
        <h1>LAPORAN PEMBATALAN PASIEN PI-CARE</h1>
    ...
    <div class="content-wrapper">
        ...
        <div class="chart-section">
            <div class="chart-title">Chart Pembatalan Pasien</div>
        ...
        <div class="table-section">
            <div class="table-title">DATA PEMBATALAN PASIEN</div>
            <table>
                <thead style="background: rgb(0, 123, 255, 1);">
                    <tr>
                        <th style="text-align: center; color: white;">Tanggal Layanan</th>
                        <th style="text-align: center; color: white;">Jumlah Pembatalan</th>
                    </tr>
                </thead>
                <tbody>
