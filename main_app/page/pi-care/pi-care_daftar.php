...
// Query untuk mengambil data pendaftaran pasien HANYA bulan ini
$bulan_ini = date('Y-m');
               ...
               <div class="col-md-6">
                    ...
                    <div class="card-body">
                         ...
                         <div style="margin-top: 10px; margin-left: 0; font-size: 15px;">
                              <b>PENDAFTARAN <?php echo strtoupper(date('F Y')); ?></b><br>
     ...
     <div class="modal-dialog">
          <div class="modal-content">
               ...
               <div class="modal-body" align="left">
                  <form action="page/pi-care/lap_pi-care_daftar_pdf.php" method="get" target="_blank">
                         <div class="row">
